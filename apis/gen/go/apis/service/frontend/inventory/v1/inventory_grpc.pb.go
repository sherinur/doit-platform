...
const (
	InventoryService_CreateProduct_FullMethodName  = "/service.frontend.inventory.v1.InventoryService/CreateProduct"
	InventoryService_GetProductByID_FullMethodName = "/service.frontend.inventory.v1.InventoryService/GetProductByID"
	InventoryService_UpdateProduct_FullMethodName  = "/service.frontend.inventory.v1.InventoryService/UpdateProduct"
	InventoryService_DeleteProduct_FullMethodName  = "/service.frontend.inventory.v1.InventoryService/DeleteProduct"
	InventoryService_ListProducts_FullMethodName   = "/service.frontend.inventory.v1.InventoryService/ListProducts"
)
...
type InventoryServiceClient interface {
	CreateProduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*v1.Product, error)
	GetProductByID(ctx context.Context, in *GetProductRequest, opts ...grpc.CallOption) (*v1.Product, error)
	UpdateProduct(ctx context.Context, in *UpdateProductRequest, opts ...grpc.CallOption) (*v1.Product, error)
...
func (c *inventoryServiceClient) CreateProduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*v1.Product, error) {
...
func (c *inventoryServiceClient) GetProductByID(ctx context.Context, in *GetProductRequest, opts ...grpc.CallOption) (*v1.Product, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.Product)
...
func (c *inventoryServiceClient) UpdateProduct(ctx context.Context, in *UpdateProductRequest, opts ...grpc.CallOption) (*v1.Product, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.Product)
...
type InventoryServiceServer interface {
	CreateProduct(context.Context, *CreateProductRequest) (*v1.Product, error)
	GetProductByID(context.Context, *GetProductRequest) (*v1.Product, error)
	UpdateProduct(context.Context, *UpdateProductRequest) (*v1.Product, error)
...
func (UnimplementedInventoryServiceServer) CreateProduct(context.Context, *CreateProductRequest) (*v1.Product, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateProduct not implemented")
}
func (UnimplementedInventoryServiceServer) GetProductByID(context.Context, *GetProductRequest) (*v1.Product, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProductByID not implemented")
}
func (UnimplementedInventoryServiceServer) UpdateProduct(context.Context, *UpdateProductRequest) (*v1.Product, error) {
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service.frontend.inventory.v1.InventoryService",
	...
	Metadata: "apis/service/frontend/inventory/v1/inventory.proto",
}
