...
type CourseRepo interface {
	...
	Update(ctx context.Context, id primitive.ObjectID, updated model.Course) error
	GetByID(ctx context.Context, id primitive.ObjectID) (*model.Course, error)
...
func (u *CourseUsecase) UpdateCourse(ctx context.Context, id primitive.ObjectID, updated model.Course) error {
	return u.repo.Update(ctx, id, updated)
}

func (u *CourseUsecase) GetCourse(ctx context.Context, id primitive.ObjectID) (*model.Course, error) {
